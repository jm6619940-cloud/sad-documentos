...
import { renderProfile } from "./pages/profile.js?v=20260714-5";
import { renderNotifications } from "./pages/notifications.js?v=20260710-1";
import { startBrowserNotificationStream, stopBrowserNotificationStream, syncAppBadge } from "./services/browserNotifications.js?v=20260714-5";
...
function registerAppServiceWorker() {
  ...
  navigator.serviceWorker.register("./sw.js?v=20260714-5", { scope: "./" })
    .then((registration) => {
