import { renderLoginShell, renderAppShell } from "./components/layout.js?v=20260708-9";
import { closeModal, openModal } from "./components/modal.js?v=20260708-9";
import { toast } from "./components/toast.js?v=20260708-9";
import { dataService } from "./services/dataService.js?v=20260708-9";
import { renderDashboard } from "./pages/dashboard.js?v=20260708-9";
import { renderNewRequest } from "./pages/newRequest.js?v=20260708-9";
import { renderRequestsTable } from "./pages/requestsTable.js?v=20260708-9";
import { renderRequestDetail } from "./pages/requestDetail.js?v=20260708-9";
import { renderUsers } from "./pages/users.js?v=20260708-9";
import { renderCatalogs } from "./pages/catalogs.js?v=20260708-9";
import { renderProfile } from "./pages/profile.js?v=20260708-9";
import { renderNotifications } from "./pages/notifications.js?v=20260708-9";
import { startBrowserNotificationStream, stopBrowserNotificationStream } from "./services/browserNotifications.js?v=20260708-9";
