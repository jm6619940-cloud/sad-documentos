const CACHE_NAME = "sad-static-v20260714-1";
...
const STATIC_ASSETS = [
  ...
  "./css/styles.css?v=20260714-1",
  "./js/app.js?v=20260714-1",
  ...
  "./js/services/browserNotifications.js?v=20260714-1",
  ...
  "./js/pages/profile.js?v=20260714-1",
