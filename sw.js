const CACHE_NAME = "sad-static-v20260714-6";
...
const STATIC_ASSETS = [
  ...
  "./css/styles.css?v=20260714-6",
  "./js/app.js?v=20260714-6",
  ...
  "./js/services/browserNotifications.js?v=20260714-6",
  ...
  "./js/pages/profile.js?v=20260714-6",
