const CACHE_NAME = "sad-static-v20260714-7";
...
const STATIC_ASSETS = [
  ...
  "./css/styles.css?v=20260714-7",
  "./js/app.js?v=20260714-7",
  ...
  "./js/services/browserNotifications.js?v=20260714-7",
  ...
  "./js/pages/profile.js?v=20260714-7",
